...
import type { BoardSettings, ProjectMetadata, TeamMember, User, ViewMode } from '../types';
        ...
        <div className="flex justify-start items-center col-span-3">
          <div className="relative">
            <select
              ...
              className="appearance-none bg-white dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-600 rounded-md px-3 py-2 pr-8 text-sm font-medium text-zinc-900 dark:text-zinc-100 hover:border-zinc-400 dark:hover:border-zinc-500 focus:outline-none focus:outline-1 focus:outline-blue-500 focus:border-blue-500"
            >
        ...
        <div className="flex justify-center items-center col-span-2">
          ...
          >
            <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <path d="M12 4v16m8-8H4" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" fill="none" />
            </svg>
            Project
          </button>
        </div>
                  ...
                  <div className="flex items-center -space-x-2">
                    ...
                    {teamMembers.slice(0, 5).map((member) => (
                      <button
                        type="button"
                        key={member.id}
                        onClick={() => onAssigneeFilterChange(assigneeFilter === member.id ? '' : member.id)}
