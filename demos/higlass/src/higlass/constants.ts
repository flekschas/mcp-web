import type { HiglassOptions, HiglassViewConfig } from './types.ts';

export const HIGLASS_DEFAULT_VIEW_CONFIG: HiglassViewConfig = {
  editable: true,
  zoomFixed: false,
  trackSourceServers: [
...
export const DEFAULT_HIGLASS_OPTIONS: HiglassOptions = {
  bounded: true,
  sizeMode: 'bounded',
  theme: 'light',
};
