 ...
 *
 * - {@link useMCPHostTheme} - Get the current host theme (`"light"` or `"dark"`)
 * - {@link useMCPHostContext} - Get the full host context (theme, display mode, locale, etc.)
 *
 * ## Advanced Exports
 *
 ...
 * - {@link useMCPApp} - Access the ext-apps `App` instance
 * - {@link MCPAppProvider} - Context provider (set up automatically by renderMCPApp)
 *
